            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                          ...
                          <button  class="btn btn-danger btn-sm" onclick="location.href = 'http://139.59.38.160/sendit/Dashboard/AllProducts.php';" style="height: 80px;">
...
function myDeactivate(id) {
  ...
  window.location.replace("http://139.59.38.160/sendit/Dashboard/del_products.php?id="+id);
  } 
}
</script>
...
function myDelete(id) {
   ...
   var txt;
  if (confirm("Delete driver! Are you sure?")) {
  window.location.replace("http://139.59.38.160/sendit/Dashboard/del_products_complete.php?id="+id);
  } 
}
</script>
