  ...
  <h3 class="menu-title">Extras</h3><!-- /.menu-title -->
   ...
   <div class="dropdown for-notification">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add Secondary Category</li>
                        </ol>
                    </div>
                </div>
            </div>
                                              ...
                                              <div class="col-lg-12">
                                                 <div class="card">
                                                    <div class="card-header">
                                                        <strong>New Secondary Category</strong>
                                                    </div>
        ...
        echo "Could not connect to DBMS"; 
         }else {  $sql =$conn->query("SELECT `ID`, `Name` FROM `menu_type` WHERE `isActive`=1");
        foreach($sql as $row) {
    ?>
...
?>
                                                     ...
                                                     <div class="row form-group">
                             <div class="col col-md-3"><label for="text-input" class=" form-control-label">Secondary Category&nbspName</label></div>
                             <div class="col-9 col-md-9"><input type="text" id="Name" name="Name" placeholder="Fresh sendit, prodessed sendit..." class="input-sm form-control-sm form-control"  required></div></div>        
